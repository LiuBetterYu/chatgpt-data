package com.lby.chatgpt.data.domain.weixin.service.message;

import com.google.common.cache.Cache;
import com.lby.chatgpt.data.domain.weixin.model.entity.MessageTextEntity;
import com.lby.chatgpt.data.domain.weixin.model.entity.UserBehaviorMessageEntity;
import com.lby.chatgpt.data.domain.weixin.model.valobj.MsgTypeVO;
import com.lby.chatgpt.data.domain.weixin.service.IWeiXinBehaviorService;
import com.lby.chatgpt.data.types.exception.ChatGPTException;
import com.lby.chatgpt.data.types.sdk.weixin.XmlUtil;
...
public class WeiXinBehaviorService implements IWeiXinBehaviorService {
    ...
    /**
     * 1. 用户的请求行为，分为事件event、消息text，这里我们只处理消息内容
